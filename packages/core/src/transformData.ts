import { BreadCrumbTypes, ErrorTypes, globalVar } from 'aoneng-fe-monitor-shared';
import {
  getLocationHref,
  getTimestamp,
  Severity,
...
import { ReportDataType, MonitorHttp, Replace, ResourceErrorTarget } from 'aoneng-fe-monitor-types';
