...
import { EMethods, MonitorHttp, MonitorXMLHttpRequest } from 'aoneng-fe-monitor-types';
import { voidFun, EventTypes, HttpTypes, HttpCodes } from 'aoneng-fe-monitor-shared';
